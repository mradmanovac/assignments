...
if (isset($_SESSION['usr_id'])) {
    if ($_SESSION['role'] == 1) {
                        ...
                        <div id="sidebar-top">
                            <div id="user-name">
                                ...
                                <form action="action.php?id= <?=  $id ?>" method="post">
                                    ...
                                    <input type="hidden" name="form_id" value="editgroup">
                                ...
                                ?>
                                                        <!--<form action="action.php?id=<?= $id ?>" method="post">
                                                                ...
                                                                <input type="hidden" name="form_id" value="deletegroup">
                                                                <input class="submit-btn" type="submit" name="submit-gr" value="IZBRIŠI">
                        ...
                        <div class="table-group tables">
                            ...
                            <div class="tables-cont">
                                <table>
                                    ...
                                    <?php
                                    $sql = "select * from groups where is_active='1'";
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $rw['created_at'] ?></td>
                                        <?php
                                        $sql2 = "SELECT count(*) FROM groups INNER JOIN users ON groups.id=users.group_id WHERE users.group_id = '$rw[id]' and users.is_active = 1";
        ...
        <?php } ?>
                                        ...
                                        <td>
                                            <a href="grupe.php?id=<?= $rw['id'] ?>">edit</a>
                                        </td>
                                    </tr>
        <?php } ?>
                                    <tr>
                                        <td colspan="5"><a href="neaktivne_grupe.php">Sve neaktivne grupe</a> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
