                                    ...
                                    <form action="action.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div id="desc-cont">
                                            <div>
                                                ...
                                                <textarea name="description" id="description" rows="10"><?= $rw['description'] ?></textarea>
                                    ...
                                    <form action="action.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div id="desc-cont">
                                            <div>
                                                ...
                                                <textarea name="description" id="description" rows="10" maxlength="1000" placeholder="Upišite opis"></textarea>
                                            </div>
                                        </div>
                                    </form>
                                <?php } ?>
